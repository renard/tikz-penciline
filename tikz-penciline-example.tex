...
\begin{tikzpicture}[penciline={jag ratio=1}]
  ...
  \draw[penciline={jag ratio=0,arc angle base2=90},ultra thick,blue] (3,3)  arc (0:-90:2cm);

  \draw[penciline={jag ratio=0,,arc angle base2=90},ultra thick,blue] (3,3)  arc (90:0:2cm);
